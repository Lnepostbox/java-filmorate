...
public class LikeDaoTest {
    ...
    public void shouldAddFilmLikeAndRemoveFilmLike() {
        ...
        int filmLikesCountBeforeAdd = filmStorage.getById(newFilm02.getId()).getLikes().size();

        likeStorage.addLike(newFilm02, newUser02);

        Film filmWithLikes = filmStorage.getById(newFilm02.getId());
        int filmLikesCountAfterAdd = filmStorage.getById(newFilm02.getId()).getLikes().size();
        ...
        Film filmWithoutLikes = filmStorage.getById(newFilm02.getId());
        int filmLikesCountAfterRemove = filmStorage.getById(newFilm02.getId()).getPopular().size();
